		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Controle de Transporte",
									"targetURL": "#zmmtransportcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmtransportcontrol-display": {
								"semanticObject": "zmmtransportcontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmtransportcontrol",
									"url": sap.ui.require.toUrl("zmmtransportcontrol")
								}
							}
						}
					}
